...
public class SmeltingGUI extends FurnaceGui {

    private final HumanEntity viewer;

    public SmeltingGUI(CustomRecipe r, ListAllRecipesGUI parent, HumanEntity entity) {
        super(r.getName(), CustomRecipes.getInstance());
        this.viewer = entity;

        FurnaceRecipe recipe = ((FurnaceRecipe) r.getRecipe());
